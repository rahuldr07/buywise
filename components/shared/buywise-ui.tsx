...
export function ProductCard({
  ...
  return (
    <article className="border-bw-border flex self-start flex-col overflow-hidden rounded-[2rem] border bg-white shadow-[0_14px_40px_rgba(15,23,42,0.055)]">
      ...
      <div className="flex flex-col p-5">
        ...
        <h3 className="font-display mt-4 line-clamp-2 h-16 text-2xl leading-tight font-black text-bw-ink">
          {product.name}
        </h3>
        <p className="mt-2 h-5 truncate text-sm font-bold text-bw-muted">
